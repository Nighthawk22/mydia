defmodule UeberauthOidcc.Request do
  ...
  defp response_mode(response_modes_supported, opts) do
    # Check if user explicitly provided a response_mode - if so, use it
    # This allows overriding the auto-selection of JARM modes
    case Map.get(opts, :response_mode) do
      mode when is_binary(mode) ->
        mode

      _ ->
        # Auto-select response mode based on provider capabilities
